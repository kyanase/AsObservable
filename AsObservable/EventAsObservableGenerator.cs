...
namespace AsObservable
{
    public static class EventAsObservableGenerator
    {
        public static string GenerateExtensionMethodOfEvent(EventInfo eventInfo)
        {
            ...
            return
                $@"public static IObservable<EventPattern<{parameterTypeName}>> {eventInfo.Name}AsObservable(this {ToGenericAwareTypeName(eventInfo.DeclaringType)} @this)
{{
